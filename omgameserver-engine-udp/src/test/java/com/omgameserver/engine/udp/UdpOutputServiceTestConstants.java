 ...
 * @since 1.0.0
 */
class UdpOutputServiceTestConstants extends BaseServiceTest implements UdpHeaderConstants {
    static private final Logger logger = LoggerFactory.getLogger(UdpOutputServiceTestConstants.class);
