...
class MsgpackDecoderTest extends Assertions {

    private final int BYTEBUFFER_SIZE = 1024;
    ...
    @Test
    public void testInteger() throws MsgpackException {
        int[] bytes = {136, 175, 112, 111, 115, 105, 116, 105, 118, 101, 95, 102, 105, 120, 105, 110, 116, 64, 165, 117,
                ...
                50, 210, 240, 0, 0, 1};
        ByteBuffer byteBuffer = createByteBuffer(bytes);
        LuaValue luaValue = msgpackDecoder.decode(byteBuffer);
        // Checks
    ...
    @Test
    public void testBigInteger() throws MsgpackException {
    ...
    @Test
    public void testBoolean() throws MsgpackException {
    ...
    @Test
    public void testStrings() throws MsgpackException {
    ...
    @Test
    public void testArray() throws MsgpackException {
    ...
    @Test
    public void testMap() throws MsgpackException {
    ...
    private ByteBuffer createByteBuffer(int[] bytes) {
        ByteBuffer byteBuffer = ByteBuffer.allocate(BYTEBUFFER_SIZE);
        for (int i = 0; i < bytes.length; i++) {
            byteBuffer.put((byte) (bytes[i] & 0xFF));
        }
        byteBuffer.flip();
        return byteBuffer;
    }
